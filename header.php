...
<center><a href="index.php"><img src="images/sparsh1.png"></a></center>
  <div id="head">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="complaintdetails.php" <?php if(basename($_SERVER['PHP_SELF']) == "complaintdetails.php"){ echo ' class="active"'; } ?>>Complaints Track</a></li>
